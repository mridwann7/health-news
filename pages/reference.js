        ...
        <div className="container px-5 py-8 mx-auto">
          <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 className="text-gray-900 text-lg title-font font-medium mb-2">Reference</h2>
              <p className="leading-relaxed text-base">News that is updated on Health news comes from WHO and other supporting websites.</p>
            </div>
          </div>
          <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 className="text-gray-900 text-lg title-font font-medium mb-2">Tools</h2>
              <p className="leading-relaxed text-base">This application is made using next.js and varcel.</p>
            </div>
          ...
          <div className="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              ...
              <p className="leading-relaxed text-base">The API source is from Rapid API</p>
            </div>
          </div>
        </div>
      </section>
